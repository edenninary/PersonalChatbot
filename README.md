...
Instructions
  ...
  5. Change directory to PersonalChatbot/src/data_processing and run: python3 preprocess_start.sh
     Your processed data should appear in a final_outputs folder and should be called formatted_data.jsonl
  6. Change directory to PersonalChatbot/src/training
  ...
  7. When step 6 is complete change directory to PersonalChatbot/src/chat
